"""Tests for omnigraph.paths — the shared test-path classifier (#1553)."""
...
# or joins an absolute path under the scan root.
...
def test_is_absolute_any_platform_accepts_both_conventions(path):
    from omnigraph.paths import is_absolute_any_platform
