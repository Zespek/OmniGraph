...
def test_pascal_no_error():
    from omnigraph.extract import extract_pascal
...
def test_lfm_no_error():
    from omnigraph.extract import extract_lazarus_form
...
def test_lpk_no_error():
    from omnigraph.extract import extract_lazarus_package
...
def test_dfm_no_error():
    from omnigraph.extract import extract_delphi_form
...
def test_pascal_no_duplicate_method_edges_regex():
    from omnigraph.extract import _extract_pascal_regex
