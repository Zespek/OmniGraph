...
from omnigraph.affected import DEFAULT_AFFECTED_RELATIONS, affected_nodes
from omnigraph.extract import _file_node_id, extract
...
def test_static_import_alongside_dynamic_is_untouched(tmp_path: Path):
    ...
    # is's subject, pinned in test_ast_captured_dynamic_import_still_gets_a_file_level_edge.
