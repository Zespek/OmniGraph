...
affected.load_graph (`omnigraph prs`), and diagnostics._read_json_file
(`omnigraph diagnose`). A truncated / invalid file (incomplete write, power loss,
...
from omnigraph.diagnostics import _read_json_file
