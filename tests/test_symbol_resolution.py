"""Tests for omnigraph.symbol_resolution."""

from __future__ import annotations

from pathlib import Path

from omnigraph.symbol_resolution import (
    _bash_make_id,
    build_label_index,
    ...
    assert resolved == [
        {
            ...
            "context": "call",
            "confidence": "INFERRED",
            "confidence_score": 0.85,  # rubric value; 0.8 is not on the scale
            "source_file": "caller.py",
            "source_location": "L2",
            "weight": 1.0,
        }
...
def test_parse_python_import_aliases_skips_function_local_imports(tmp_path):
    ...
    from omnigraph.symbol_resolution import parse_python_import_aliases
...
def test_node_is_resolvable_symbol_requires_code_file_type():
    ...
    from omnigraph.symbol_resolution import node_is_resolvable_symbol
...
def test_build_label_index_excludes_non_code_nodes():
    ...
    from omnigraph.symbol_resolution import build_label_index
...
def test_resolve_bash_source_edges_skips_malformed_source(tmp_path):
    ...
    from omnigraph.symbol_resolution import resolve_bash_source_edges
...
def test_iter_raw_calls_skips_non_dict_per_file_entries():
    ...
    from omnigraph.symbol_resolution import iter_raw_calls
...
def test_resolve_cross_file_raw_calls_survives_malformed_raw_calls():
    ...
    from omnigraph.symbol_resolution import resolve_cross_file_raw_calls
...
def test_resolve_python_import_guided_calls_survives_malformed_raw_calls(tmp_path):
    ...
    from omnigraph.symbol_resolution import resolve_python_import_guided_calls
...
def test_resolve_python_import_guided_calls_metadata_sanitizes_hostile_alias(
    ...
    """
    import omnigraph.symbol_resolution as sr
