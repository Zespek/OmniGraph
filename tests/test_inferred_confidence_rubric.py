...
is not in the discrete set. On omnigraph's own package that was 128 of 128
...
from omnigraph.export import _CONFIDENCE_SCORE_DEFAULTS

# The discrete INFERRED set from references/extraction-spec.md.
RUBRIC = {0.55, 0.65, 0.75, 0.85, 0.95}

SRC = Path(__file__).resolve().parent.parent / "omnigraph"
