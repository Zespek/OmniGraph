...
from omnigraph.detect import FileType, classify_file
from omnigraph.extract import extract
from omnigraph.manifest_ingest import (
...
# ── a package referenced by N manifests is ONE node ───────────────────
...
# ── Cargo.toml joins pyproject.toml/go.mod/pom.xml as a package manifest ─
