"""Comprehensive tests for omnigraph.scip_ingest."""

from __future__ import annotations

import pytest

from omnigraph.scip_ingest import (
...
def test_relationship_edges_survive_validate_extraction_and_build():
    """Result passes OmniGraph's validate_extraction and build_from_json keeps the edges."""
