"""Tests for the Ollama backend additions in omnigraph/llm.py."""
from __future__ import annotations

import pytest

from omnigraph.llm import detect_backend, BACKENDS, _validate_ollama_base_url
...
def test_ollama_api_key_sentinel(monkeypatch):
    ...
    with patch("omnigraph.llm._call_openai_compat", return_value=fake_result) as mock_call:
        from omnigraph.llm import extract_files_direct
