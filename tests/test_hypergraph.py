"""Tests for hyperedge support in omnigraph."""
...
from omnigraph.export import attach_hyperedges, to_json
...
def test_attach_hyperedges_tolerates_id_less_persisted():
    # Regression for the semantic extractor emits hyperedges with no `id`
...
# ---------------------------------------------------------------------------
# 7. Hyperedge member-key alias normalization
# ---------------------------------------------------------------------------
