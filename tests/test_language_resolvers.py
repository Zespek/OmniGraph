"""Tests for the language resolver registry (omnigraph.resolver_registry).
...
from omnigraph.resolver_registry import (
    LanguageResolver,
...
def test_default_registry_contains_swift_then_python() -> None:
    ...
    import omnigraph.extract  # noqa: F401  (registers resolvers on import)
