...
Example output:
    === OmniGraph AST Extraction Benchmark ===
    Files:        1,247
...
from omnigraph.extract import extract, collect_files
from omnigraph.cache import clear_cache
...
def main() -> None:
    ...
    print("=== OmniGraph AST Extraction Benchmark ===\n")
