"""Tests for omnigraph/_minhash.py — MinHash sketch and band-LSH."""
from __future__ import annotations
import numpy as np
import pytest
from omnigraph._minhash import MinHash, MinHashLSH, _optimal_lsh_params
...
def test_dedup_import_does_not_pull_scipy_or_numpy_testing():
    ...
    import omnigraph.dedup  # noqa: F401
