...
import tempfile
import pytest
from omnigraph.extract import extract, extract_sln, extract_slnx, extract_csproj, extract_xaml, extract_razor
...
def test_xaml_viewmodel_resolution_respects_omnigraphignore(tmp_path):
    project = tmp_path / "xaml_viewmodel"
    shutil.copytree(FIXTURES / "xaml_viewmodel", project)
    (project / ".omnigraphignore").write_text("ViewModels/MainViewModel.cs\n", encoding="utf-8")
