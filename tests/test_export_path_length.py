...
directory therefore overruns MAX_PATH, and `omnigraph export obsidian` /
...
from omnigraph import export as export_mod
from omnigraph import wiki as wiki_mod
from omnigraph.export import _obsidian_safe_stem, to_canvas, to_obsidian
from omnigraph.paths import _MIN_STEM_BUDGET, _WINDOWS_MAX_PATH, stem_filename_budget
from omnigraph.wiki import _safe_filename, to_wiki
...
def test_budget_shrinks_so_the_whole_path_fits_max_path(monkeypatch):
    ...
    vault = r"C:\Users\dev\projects\payments-api\omnigraph-out\obsidian"
