"""Tests for omnigraph.wiki — Wikipedia-style article generation."""
import re
import pytest
from pathlib import Path
import networkx as nx
from omnigraph.wiki import to_wiki, _index_md, _community_article, _god_node_article
...
# Regression tests for - cross-community links always empty when node attrs lack community
...
# Regression tests for - stale community node IDs crash to_wiki after dedup/re-extract
