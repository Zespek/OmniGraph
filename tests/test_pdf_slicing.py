...
Papers are the longest documents anyone points omnigraph at, and a compressed
...
from omnigraph.llm import _FILE_CHAR_CAP, _file_to_text, _read_files

try:  # the reader this fix introduces
    from omnigraph.file_slice import unit_source_text
