...
omnigraph's own corpus that rewrote all 144 pairs where the extraction found both
...
from omnigraph.build import build_from_json, edge_data
...
def test_the_reported_case_keeps_calls():
    """The exact shape seen 144 times on omnigraph's own graph."""
