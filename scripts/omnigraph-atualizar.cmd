@echo off
REM =============================================================================
REM  Atalho 'omnigraph-atualizar' para o Windows.
REM
...
REM =============================================================================
setlocal
set "OG_PS1=%LOCALAPPDATA%\OmniGraph\lib\omnigraph-atualizar.ps1"
if not exist "%OG_PS1%" set "OG_PS1=%~dp0omnigraph-atualizar.ps1"
