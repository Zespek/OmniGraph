...
Concept 1 ("The Path Lights Up"): a terminal types `omnigraph path ...` on the
...
BORDER    = "#33184a"
DIVIDER   = "#2a1440"
DIM_NODE  = "#3a2450"         # nos apagados
DIM_EDGE  = "#2e1a42"         # arestas apagadas
GREEN     = "#bd00ff"         # roxo da marca (aceso)
GREEN_HI  = "#d94dff"         # roxo claro (destaques/legenda)
GREEN_DK  = "#9500cc"         # roxo profundo
TXT       = "#ede4f5"         # texto principal do terminal
TXT_DIM   = "#9b7fb0"         # texto secundario
PROMPT    = "#bd00ff"
...
e(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" '
  ...
  f'aria-label="omnigraph path query lighting up a knowledge graph">')
e('<defs>')
...
e(f'<text x="{PANEL-16}" y="34" text-anchor="end" font-size="10" fill="{TXT_DIM}">omnigraph</text>')
...
cmd = 'omnigraph path "FastAPI" "ModelField"'
