...
CLI: ``omnigraph tree [--graph PATH] [--output HTML] [--root PATH]
...
def build_tree(
    ...
    *,
    ...
    for src_file, syms in sorted(by_file.items()):
        ...
        # Nó de arquivo – filhos são os símbolos.
        ...
        # Classifique: codifique os símbolos primeiro pelo nome e depois por qualquer outra coisa.
    ...
    # Classifique os filhos de cada diretório + propague total_count up.
...
def write_tree_html(
    ...
    *,
    ...
    title = f"{tree['name']} — omnigraph tree viewer"
