"""Fortran extractor. Moved verbatim from omnigraph/extract.py."""
...
def extract_fortran(path: Path) -> dict:
    ...
    def emit_signature_refs(scope_node, fn_nid: str, is_function: bool) -> None:
        ...
        if is_function:
            ...
            if result_node is not None:
                ...
                # variável de resultado implícita: mesmo nome da função
    ...
    def walk(node, scope_nid: str) -> None:
        ...
        # sub-rotinas/funções dentro de um módulo residem em internal_procedures
        ...
        if t == "use_statement":
            line = node.start_point[0] + 1
            # tree-sitter-fortran usa o nó module_name para o módulo usado
