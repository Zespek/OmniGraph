"""Elixir extractor. Moved verbatim from omnigraph/extract.py."""
from __future__ import annotations

from pathlib import Path
from typing import Any

from omnigraph.extractors.base import _LANGUAGE_BUILTIN_GLOBALS, _file_stem, _make_id
