...
# Registro em nível de módulo, preenchido por chamadores via registrador(). Ordenado: resolvedores
# executado em ordem de registro, preservando qualquer sequência necessária entre passagens.
