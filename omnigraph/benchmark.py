"""Token-reduction benchmark - measures how much context omnigraph saves vs naive full-corpus approach."""
from __future__ import annotations
import sys
import networkx as nx

from omnigraph.build import edge_data
from omnigraph.serve import _query_terms
...
def run_benchmark(
    ...
    """Measure token reduction: corpus tokens vs omnigraph query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\nomnigraph token reduction benchmark")
    print(_hr(50))
    arrow = _safe("→", "->")
