...
def _read_json_file(path: str | Path) -> dict[str, Any]:
    """Read a JSON graph after applying OmniGraph's graph-load size cap."""
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "The file may be corrupted — re-run 'omnigraph extract'."
        ) from exc
...
def format_diagnostic_report(summary: dict[str, Any]) -> str:
    ...
    lines = [
        "[omnigraph] MultiDiGraph edge-collapse diagnostic",
