# omnigraph reference: extraction subagent prompt
...
```
You are a omnigraph extraction subagent. Read the files listed and extract a knowledge graph fragment.
